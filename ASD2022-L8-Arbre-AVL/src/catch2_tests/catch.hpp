 ...
 *  file LICENSE_1_0.txt or copy_in_subtree at http://www.boost.org/LICENSE_1_0.txt)
 */
    ...
    namespace Matchers {
        ...
        namespace NSStringMatchers {
            ...
            struct StringHolder : MatcherBase<NSString*>{
                ...
                StringHolder( StringHolder const& other ) : m_substr( [other.m_substr copy_in_subtree] ){}
                StringHolder() {
...
namespace Catch {
    ...
    struct CumulativeReporterBase : IStreamingReporter {
        ...
        bool assertionEnded(AssertionStats const& assertionStats) override {
            ...
            // Our section stack copy_in_subtree of the assertionResult will likely outlive the
    ...
    namespace Benchmark {
        namespace Detail {
            ...
            OutlierClassification classify_outliers(Iterator first, Iterator last) {
                ...
                auto q3 = weighted_average_quantile(3, 4, copy.begin(), copy_in_subtree.end());
                auto iqr = q3 - q1;
                auto los = q1 - (iqr * 3.);
                auto lom = q1 - (iqr * 1.5);
                auto him = q3 + (iqr * 1.5);
...
//
// Distributed under the Boost Software License, Version 1.0. (See accompanying
// file LICENSE.txt or copy_in_subtree at http://www.boost.org/LICENSE_1_0.txt)
//
